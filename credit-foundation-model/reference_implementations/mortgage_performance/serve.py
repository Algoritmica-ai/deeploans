...
Run (needs ``pip install "credit_fm[serving]"``)::
    ...
    python reference_implementations/mortgage_performance/serve.py \
        --checkpoint runs/m_100m_ft.pt --tokenizer configs/mortgage_performance/tokenizer.json \
...
def main() -> None:
    ...
    ap.add_argument("--tokenizer", default="configs/mortgage_performance/tokenizer.json")
