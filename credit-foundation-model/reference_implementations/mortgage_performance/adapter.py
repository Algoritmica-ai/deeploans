...
Derived columns (the contract in ``configs/mortgage_performance/dataset.yaml``):
...
Used via the stock driver (``python scripts/ingest.py -c configs/mortgage_performance/ingest_2000_2024.yaml``)
