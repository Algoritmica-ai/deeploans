...
| 5 | [05_dataset.md](05_dataset.md) | the publisher data, defaults, prepayment, zero-balance codes |
| 6 | [06_ingestion.md](06_ingestion.md) | `ingest.py` + the the publisher adapter, line of business logic |
