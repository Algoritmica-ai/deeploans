...
This output should be ingested into Deeploans CRE tables first; the CMBS app (`app-library/cmbs-data-provider-workbench`) then consumes it via Deeploans API endpoints.
